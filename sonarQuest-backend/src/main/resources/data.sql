...
INSERT INTO Developer (username, gold, xp, level_id,picture,about_me,avatar_class_id,avatar_race_id) VALUES
  ('Eddie Tor', 10, 5, 1, null ,'Quick with the keys as well as the daggers, Eddie knows hidden paths to chambers of wisdom unknown!',4,2),
  ('Ringo Rockstar', 30, 20, 2, null ,'The mighty barbarian has the strength and the tools to do the job. Brute force ftw!',2,3),
  ('Mike Magician', 18, 15, 2, null,'Raised in the Lands of the North, wisdomey and experienced, this talented Magician will find a solution for everything. And sometimes it might really look like magic!',1,1);
